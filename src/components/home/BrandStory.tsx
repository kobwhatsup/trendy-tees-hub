    ...
    <section className="py-24 px-4 bg-gradient-to-br from-primary/5 via-white to-secondary/5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="p-8 rounded-xl bg-white/80 backdrop-blur-sm shadow-md hover:shadow-lg transition-all duration-300 group">
            ...
            <h3 className="font-bold text-xl mb-4 text-primary">匠心品质</h3>
          ...
          <div className="p-8 rounded-xl bg-white/80 backdrop-blur-sm shadow-md hover:shadow-lg transition-all duration-300 group">
            ...
            <h3 className="font-bold text-xl mb-4 text-secondary">AI创新</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="p-8 rounded-xl bg-white/80 backdrop-blur-sm shadow-md hover:shadow-lg transition-all duration-300 group">
            ...
            <h3 className="font-bold text-xl mb-4 text-primary">环保理念</h3>
            <p className="text-muted-foreground leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-md">
            <h4 className="font-semibold text-lg mb-3 text-primary">我们的使命</h4>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-md">
            <h4 className="font-semibold text-lg mb-3 text-secondary">未来展望</h4>
            <p className="text-muted-foreground leading-relaxed">
